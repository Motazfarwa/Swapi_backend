...
// const { pool } = require('../db');  // Fix: Properly destructure the pool from the import
...
// router.get('/', (req, res) => {
//   res.json({ message: 'SWAPI Service is running' });
// });
...
//     const result = await pool.query(
//       'INSERT INTO payments (payment_id, amount, currency, customer_name, customer_email, description) VALUES ($1, $2, $3, $4, $5, $6) RETURNING *',
//       [paymentId, amount / 100, 'usd', metadata.name, metadata.email, metadata.description]
//     );
